...
export function Card({ title, link, type, id, createdAt, isDeletable }: CardProps) {
 ...
 useEffect(()=>{
        ...
        <div className=" border border-gray-200 bg-white rounded-xl shadow-md min-h-48 max-h-auto    flex flex-col justify-between  ">
            ...
            <div  className="flex  justify-between text-gray-500 p-2">
                ...
                className="flex gap-3 items-center hover:text-gray-700 ">
                    ...
                    <div className="cursor-pointer hover:text-gray-700" onClick={handleDelete}>
                       <span className=""> <RiDeleteBin5Line /> </span> 
                    </div>
                </div>
            </div>
    ...
    {type === "Instagram" && (
      ...
      <InstagramEmbed url={link}  className="rounded-xl w-[267px] md:w-[317px]" />
    </div>
    )}
    {type === "Facebook" && (
       <div style={{ display: 'flex', justifyContent: 'center' }}>
