...
<div  className={` ${
        open ? "w-52" : "w-12"
         ...
         <div  className={ `absolute    border-2 border-amber-400  left-48   w-4/5 `}>
      <div>
        ...
        <Popup isOpenShare={isOpenShare} onClose={()=>{
          ...
          <div className=" flex   border-2 border-amber-800  w-64 md:w-full justify-end">
          <HeaderData setIsOpen={setIsOpen} setIsOpenShare={setIsOpenShare}/>
          </div>
       
    
     <div className={` ${!open ? "-ml-28":"-ml-40  lg:ml-12 "}  border-2 border-amber-400  transition-property: all duration-300 ease-in `}>
     {user && (
      ...
      <div className={` ${!open ? "-ml-32":"-ml-44  lg:ml-12 "}  min-h-screen  border-2 border-green-800 flex  gap-5 p-6 bg-[#F4F4FC] mr-auto rounded-3xl w-64 md:w-full  flex-wrap  `}>
