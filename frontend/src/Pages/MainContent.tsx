...
<div  className={` ${
        open ? "w-52" : "w-12"
         ...
         <div  className={ `absolute border-red-800   border-2    w-4/5 `}>
      <div>
     ...
     <div className={` ${!open ? "-translate-x-28":"translate-x-40  lg:translate-x-12 "}  border-amber-300 border-2 transition-property: all duration-300 ease-in `}>
     {user && (
